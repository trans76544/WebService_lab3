...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements QiYeJianMo.WeatherWebService {
 ...
 */
    ...
    public QiYeJianMo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public QiYeJianMo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            QiYeJianMo.WeatherWebServiceSoap12Stub _stub = new QiYeJianMo.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public QiYeJianMo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public QiYeJianMo.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            QiYeJianMo.WeatherWebServiceSoap_BindingStub _stub = new QiYeJianMo.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (QiYeJianMo.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                QiYeJianMo.WeatherWebServiceSoap12Stub _stub = new QiYeJianMo.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (QiYeJianMo.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                QiYeJianMo.WeatherWebServiceSoap_BindingStub _stub = new QiYeJianMo.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
